...
$queryTransDetail = mysqli_query($koneksi, "SELECT trans_order.order_code, trans_order.order_date, trans_order.order_end_date, trans_order.order_status, trans_order.discount, trans_order.order_pay, trans_order.order_change, type_of_service.service_name, type_of_service.price, trans_order_detail.* FROM trans_order_detail LEFT JOIN type_of_service ON type_of_service.id = trans_order_detail.id_service LEFT JOIN trans_order ON trans_order.id = trans_order_detail.id_order WHERE trans_order_detail.id_order = '$id'");
...
if (isset($_POST['simpan'])) {
    ...
    $insertTransOrder = mysqli_query($koneksi, "INSERT INTO trans_order (id_customer, order_code, order_date, order_end_date, order_pay, order_change, discount) VALUES ('$id_customer', '$order_code', '$order_date', '$order_end_date', '$order_pay', '$order_change', '$discount')");
...
<body>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6" align="right">
                                                    <a target="_blank" href="print.php?id=<?php echo $rowTransDetail[0]['id_order'] ?>"
                                            ...
                                            <div class="card-body">
                                                <table class="table table-bordered table-striped">
                                                    <tr>
                                                        <th>No. Invoice</th>
                                                        <th>
                                                            <?php echo isset($rowTransDetail[0]['order_code']) ? $rowTransDetail[0]['order_code'] : 'N/A'; ?>
                                                        </th>
                                                    </tr>
                                                    <tr>
                                                        <th>Tanggal Laundry</th>
                                                        <th>
                                                            <?php echo isset($rowTransDetail[0]['order_date']) ? date('d-m-Y', strtotime($rowTransDetail[0]['order_date'])) : 'N/A'; ?>
                                                        </th>
                                                        <th>
                                                            <?php echo isset($rowTransDetail[0]['order_end_date']) ? date('d-m-Y', strtotime($rowTransDetail[0]['order_end_date'])) : 'N/A'; ?>
                                                        </th>
                                                    </tr>
                                                    <tr>
                                                        <th>Status</th>
                                            ...
                                            <div class="card-body">
                                                <table class="table table-bordered table-striped">
                                                    ...
                                                    <tr>
                                                        <th>Alamat</th>
                                                        <th>
                                                            <?php echo isset($customerDetail[0]['address']) ? $customerDetail[0]['address'] : 'N/A'; ?>
                                                        </th>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" class="form-control" name="order_code" placeholder="Generated Order Code"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <label for="order_end_date" class="form-label">Tanggal Selesai Order</label>
                                                ...
                                                <div class="form-group">
                                                    <label for="order_pay">Pembayaran (Rp)</label>
                                                    <input type="number" id="order_pay" name="order_pay" class="form-control"
                                                        placeholder="Masukkan jumlah pembayaran" step="0.01">
                                                </div>

                                                <div class="form-group">
                                                    <label for="order_change">Kembalian (Rp)</label>
                                                    <input type="number" id="order_change" name="order_change" class="form-control"
                                                        placeholder="Masukkan jumlah kembalian" step="0.01" readonly>
                                                </div>
                                            ...
                                            <div class="card-body">
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="mt-3 col-9">
                                                        <input type="number" class="form-control" name="qty[]" placeholder="Masukkan qty (kg)"
                                                            value="">
                                                    </div>
                                                </div>
    ...
    <script>
        // Menambahkan event listener pada input order_pay untuk menghitung kembalian
        document.getElementById('order_pay').addEventListener('input', function() {
            var totalAmount =
                100000; // Total biaya yang harus dibayar, ini bisa diganti dengan total transaksi yang dinamis
            var payment = parseFloat(this.value); // Mengambil nilai dari input pembayaran
            var change = payment - totalAmount; // Menghitung kembalian

            // Menampilkan hasil kembalian atau 0 jika pembayaran kurang
            if (change < 0) {
                document.getElementById('order_change').value = '0';
            } else {
                document.getElementById('order_change').value = change.toFixed(2); // Format dengan dua angka desimal
            }
        });
    </script>
