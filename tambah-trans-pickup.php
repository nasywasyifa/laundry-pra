...
$queryTransDetail = mysqli_query($koneksi, "SELECT trans_order.order_code, trans_order.order_date, trans_order.order_end_date, trans_order.order_status, trans_order.id_customer, type_of_service.service_name, type_of_service.price, trans_order_detail.* FROM trans_order_detail LEFT JOIN type_of_service ON type_of_service.id = trans_order_detail.id_service LEFT JOIN trans_order ON trans_order.id = trans_order_detail.id_order WHERE trans_order_detail.id_order = '$id'");
...
if (isset($_POST['simpan_transaksi'])) {
    ...
    $insertPickUp = mysqli_query($koneksi, "INSERT INTO trans_laundry_pickup (id_customer, id_order, pickup_date, final_total) 
        VALUES ('$id_customer', '$id_order', '$pickup_date', '$final_total')");
                ...
                <div class="content-wrapper">
                    ...
                    <?php if (isset($_GET['ambil'])): ?>
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <div class="row">
                                <div class="mb-3">
                                    <a href="tambah-transaction.php?detail=<?php echo $rowTransDetail[0]['id_order'] ?>"
                              ...
                              <td>
                                <input type="number" name="discount" id="discount" class="form-control"
                                  value="<?php echo isset($_POST['discount']) ? $_POST['discount'] : '0' ?>" min="0"
                                  max="100">
                              </td>
                            </tr> -->
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="text" class="form-control" name="final_total"
                                                                        value="<?php echo "Rp" . number_format($final_total) ?>" readonly>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    ?>
                                                                    <input type="text" name="pickup_change" placeholder="Kembalian" class="form-control"
                                                                        value="<?php echo isset($kembalian) ? $kembalian : '0' ?>" readonly>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <input type="hidden" name="id_customer"
                                                                value="<?php echo $rowTransDetail[0]['id_customer'] ?>">
